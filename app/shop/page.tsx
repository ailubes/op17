                    ...
                    {cart.map((item, index) => (
                      <div key={index} className="flex gap-4 p-4 bg-slate-800 border border-white/10">
                        ...
                        <div className="flex-1">
                          ...
                          {item.size && <p className="text-slate-400 text-sm">Size: {item.size}</p>}
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden bg-slate-800 border border-white/10 mb-4">
        ...
        {product.badge && (
          <span
            className={`absolute top-3 left-3 px-3 py-1 font-barlow font-bold text-xs uppercase tracking-wider ${
              product.badge === 'SALE'
        ...
        {product.inStock && (
          <div
            className={`absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-slate-950 via-slate-950/90 to-transparent transition-all duration-300 ${isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          >
            {product.sizes && (
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center gap-2 mt-2">
          ...
          {product.originalPrice && (
            <span className="font-inter text-slate-500 line-through text-sm">
