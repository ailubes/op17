...
interface Product {
  ...
  variants: Variant[];
  media?: { id: string; objectKey: string; bucket: string }[];
}
      ...
      <section className="pt-32 pb-16 bg-gradient-to-b from-slate-900 to-slate-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-14 text-center relative z-10">
          ...
          <p className="font-inter text-slate-400 max-w-xl mx-auto text-lg">
            Gear up with official OP17 drops and always-on essentials.
          </p>
        ...
        <div className="container mx-auto px-6 md:px-14">
          {loading ? (
            ...
            <div className="text-center py-20">
              <p className="font-inter text-slate-400 text-lg">No products available.</p>
            </div>
          ) : (
        ...
        <div className="container mx-auto px-6 md:px-14">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bebas text-2xl text-white mb-2">Secure Checkout</h3>
              <p className="font-inter text-slate-400 text-sm">Pay with LiqPay or Monobank</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gold/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-bebas text-2xl text-white mb-2">Official Gear</h3>
              <p className="font-inter text-slate-400 text-sm">Verified OP17 merchandise</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gold/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-bebas text-2xl text-white mb-2">Nova Post Delivery</h3>
              <p className="font-inter text-slate-400 text-sm">Branch pickup or courier</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-8 border-t border-white/10">
        <div className="container mx-auto px-6 md:px-14 text-center">
          <p className="font-inter text-slate-500 text-sm">
            &copy; {new Date().getFullYear()} Plotnytskyi Collection. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
