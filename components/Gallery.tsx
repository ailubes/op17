...
const images = [
  {
    ...
    alt: "The Beast in Action",
    category: "Portrait",
    height: "h-96"
  },
  {
    src: "/images/oleh-celebration.jpg",
  ...
  {
    src: "/images/oleh-mvp.jpg",
    alt: "Club World Championship MVP",
    category: "Awards",
    height: "h-72"
  },
  {
    src: "/images/oleh-portrait.jpg",
    alt: "Sir Sicoma Perugia",
    category: "Portrait",
    height: "h-80"
  },
  {
    src: "/images/oleh-action-2.jpg",
    alt: "Match Intensity",
    category: "Action",
    height: "h-64"
  },
  {
    src: "/images/oleh-action-3.jpg",
    alt: "Court Dominance",
    category: "Highlights",
    height: "h-96"
  },
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 reveal opacity-0 translate-y-10 transition-all duration-1000">
                <div>
                    <h2 className="font-bebas text-6xl md:text-8xl uppercase tracking-tight leading-none mb-4">
                        Moments in <span className="text-gold">Motion</span>
                    </h2>
